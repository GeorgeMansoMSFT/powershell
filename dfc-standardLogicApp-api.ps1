...
# -----------------------------------------------------------------------------
$subscriptionId     = "05ddf88a-5bc5-4b68-be30-4be7bd310885"
$automationRG       = "GM-LogicApp"
$automationName     = "Test-Standard-Automation"
$logicAppName       = "d4s-malware-standard"
$logicAppRG         = "GM-LogicApp"
$workflowName       = "D4S-Malware-Quarantine"
