...
<p class="meta" style="margin-top: 3em; border-top: 1px solid #eee; padding-top: 1em;">
  Generated by Verified Domain Discovery Toolkit. This is a read-only inventory &mdash; no changes were made to the tenant.<br/>
  <em>This is an independent community tool, not affiliated with or supported by Microsoft Corporation. Provided as-is, without warranty. Validate findings before taking action.</em>
</p>
